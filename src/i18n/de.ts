...
export const de = {
  ...
  'privacy.processorsText':
    'Die Daten liegen bei Google Firebase (Firestore-Datenbank, Authentifizierung) als technischem Auftragsverarbeiter; je nach gewählter Firestore-Region können Server auch außerhalb der EU (z.B. USA) stehen. Ist Sentry für Fehler-Monitoring konfiguriert (siehe README), erhält Sentry technische Fehlerberichte: Fehlermeldung, Fehlerspur, App-Version, die Roadtrip-ID und die Konto-Kennung des Geräts – keinen Namen, keine Standort- oder Kostendaten, wohl aber das, was eine Fehlermeldung im Einzelfall mitbringt. Die Konto-Kennung ist eine Zeichenfolge ohne eigene Aussagekraft; wer dahintersteckt, ist nur über die Crew-Liste des Roadtrips zu erfahren. Ist zusätzlich Firebase App Check eingeschaltet (Schutz vor automatisierten Zugriffen), bindet die App Google reCAPTCHA ein; dabei werden Geräte- und Nutzungsmerkmale an Google übertragen.',
  ...
  // --- Statistik (pages/Statistics.tsx, lib/statistics.ts) --------------
  'stats.title': 'Statistik',
  'stats.subtitle': 'Die aufgezeichneten Fahrdaten ausgewertet',
  'stats.scopeLabel': 'Ausschnitt',
  'stats.scopeTrip': 'Gesamt',
  'stats.scopeDay': 'Tag',
  'stats.scopeRoute': 'Fahrt',
  'stats.selectDay': 'Tag wählen',
  'stats.selectRoute': 'Fahrt wählen',
  'stats.noDays': 'Noch kein Tag mit Aufzeichnung.',
  'stats.noRoutes': 'Noch keine Fahrt benannt – benennen lässt sie sich beim Stoppen der Tour.',
  'stats.empty': 'Nichts auszuwerten',
  'stats.emptyHint': 'Sobald eine Tour aufgezeichnet ist, stehen hier Strecke, Tempo und Verteilung.',
  'stats.distance': 'Strecke',
  'stats.duration': 'Zeitraum',
  'stats.durationHint': 'Erster bis letzter Punkt',
  'stats.movingTime': 'Fahrzeit',
  'stats.movingShare': '{percent} % der Zeit',
  'stats.restingTime': 'Standzeit',
  'stats.avgSpeed': 'Ø Tempo',
  'stats.movingSpeed': 'Ø in Fahrt',
  'stats.movingSpeedHint': 'Ohne Standzeiten',
  'stats.maxSpeed': 'Höchsttempo',
  'stats.maxSpeedAt': 'um {time}',
  'stats.points': 'Trackpunkte',
  'stats.pointCount_one': '{count} Punkt',
  'stats.pointCount_other': '{count} Punkte',
  'stats.eventCount_one': '{count} Ereignis',
  'stats.eventCount_other': '{count} Ereignisse',
  'stats.activeDays': 'Reisetage',
  'stats.routeCount_one': '{count} Fahrt',
  'stats.routeCount_other': '{count} Fahrten',
  'stats.speedSection': 'Geschwindigkeit',
  'stats.speedChartAria': 'Geschwindigkeitsverlauf, Spitze {peak}, Durchschnitt {average}',
  'stats.speedDistribution': 'Verteilung',
  'stats.speedDistributionHint':
    'Wie viele Messwerte in welcher Klasse lagen – ein Durchschnitt allein verrät nicht, ob es gleichmäßig voranging.',
  'stats.crewSection': 'Crew',
  'stats.crewHint': 'Strecke je Person, getrennt gerechnet – die Spuren mehrerer Fahrzeuge liegen ineinander.',
  'stats.eventsSection': 'Ereignisse',
  'stats.eventsEmpty': 'In diesem Ausschnitt wurde nichts ins Logbuch eingetragen.',
  'stats.daysSection': 'Tage im Vergleich',
  'stats.routesSection': 'Aufgezeichnete Fahrten',

  // --- Toiletten (pages/Toilets.tsx, lib/toiletStops.ts) ----------------
  'toilets.title': 'Toiletten',
  'toilets.subtitle': 'Zähler und Karte – bewusst außerhalb des Logbuchs',
  'toilets.privacyNote':
    'Die Marker sieht die ganze Crew: Wo es unterwegs eine Toilette gab, hilft allen. Die Beschreibung nach der Bristol-Skala liest nur, wer sie eingetragen hat.',
  'toilets.total': 'Stopps der Crew',
  'toilets.mine': 'Deine Stopps',
  'toilets.perDay': 'Ø pro Reisetag',
  'toilets.perDayHint': 'Gezählt werden nur Tage mit Einträgen.',
  'toilets.addSection': 'Stopp eintragen',
  'toilets.bristolLabel': 'Beschreibung (Bristol-Skala)',
  'toilets.placeLabel': 'Örtlichkeit',
  'toilets.addHere': 'Hier eintragen',
  'toilets.addHereHint': 'Übernimmt die aktuelle GPS-Position.',
  'toilets.placeOnMap': 'Auf Karte setzen',
  'toilets.placeOnMapStop': 'Setzen beenden',
  'toilets.placeOnMapHint': 'Ein Tipp auf die Karte setzt den Stopp dorthin – für alles, was erst abends nachgetragen wird.',
  'toilets.added': 'Stopp eingetragen',
  'toilets.updated': 'Stopp geändert',
  'toilets.noPosition': 'Noch keine GPS-Position – so lange hilft „Auf Karte setzen“.',
  'toilets.mapSection': 'Karte',
  'toilets.empty': 'Noch kein Stopp eingetragen',
  'toilets.emptyHint': 'Der erste Halt an der Tankstelle darf hier stehen.',
  'toilets.crewSection': 'Crew im Vergleich',
  'toilets.stopCount_one': '{count} Stopp',
  'toilets.stopCount_other': '{count} Stopps',
  'toilets.distributionSection': 'Deine Verteilung',
  'toilets.distributionHint': 'Nur deine eigenen Einträge – für die anderen ist diese Zeile leer.',
  'toilets.noDetails': 'Noch nichts beschrieben.',
  'toilets.dominant': 'Häufigster Typ',
  'toilets.detailPrivate': 'Beschreibung ist privat.',
  'toilets.editStop': 'Stopp bearbeiten',
  'toilets.dragHint': 'Eigene Marker lassen sich verschieben.',
  'toilets.deleteTitle': 'Stopp löschen?',
  'toilets.deleteDescription':
    'Der Eintrag wandert in den Papierkorb und lässt sich von dort zurückholen. Die Beschreibung bleibt so lange bei ihm.',
  'toilets.trashed': 'Stopp in den Papierkorb gelegt',
  'toilets.restored': 'Stopp wiederhergestellt',
  'toilets.bristol.1': 'Typ 1 · Einzelne harte Kügelchen',
  'toilets.bristol.2': 'Typ 2 · Wurst, klumpig',
  'toilets.bristol.3': 'Typ 3 · Wurst mit Rissen',
  'toilets.bristol.4': 'Typ 4 · Wurst, glatt und weich',
  'toilets.bristol.5': 'Typ 5 · Weiche Klümpchen',
  'toilets.bristol.6': 'Typ 6 · Breiig mit fransigen Rändern',
  'toilets.bristol.7': 'Typ 7 · Flüssig, ohne feste Teile',
  'toilets.tendency.hard': 'eher fest',
  'toilets.tendency.normal': 'im Rahmen',
  'toilets.tendency.soft': 'eher weich',
  'toilets.place.gasStation': 'Tankstelle',
  'toilets.place.restaurant': 'Restaurant oder Café',
  'toilets.place.nature': 'Wald und Wiese',
  'toilets.place.campsite': 'Campingplatz',
  'toilets.place.publicToilet': 'Öffentliche Toilette',
  'toilets.place.accommodation': 'Unterkunft',
  'toilets.place.vehicle': 'Im Fahrzeug',
  'toilets.place.other': 'Sonstiges',
