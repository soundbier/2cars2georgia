...
export const de = {
  ...
  'map.offlineNoRoute': 'Noch keine Route vorhanden – erst im Routenplaner eine Route aktivieren oder losfahren.',
  ...
  'map.offlineSourcePlanned': 'geplanter Route „{name}“',
  ...
  'plan.unnamed': 'Ohne Namen',
  'plan.noDate': 'Ohne Tag',
  'plan.points_one': '{count} Wegpunkt',
  'plan.points_other': '{count} Wegpunkte',
  'plan.active': 'aktiv',
  ...
  'plan.clear': 'Alle Wegpunkte löschen',
  'plan.done': 'Fertig',
  'plan.emptyTitle': 'Noch keine Route geplant',
  ...
  // --- Bereichsumschalter (Einstellungen / Routen) -----------------------
