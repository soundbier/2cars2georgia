...
export const de = {
  ...
  'map.lockNorth': 'Karte auf Norden fixieren',
  'map.unlockNorth': 'Nordfixierung aufheben',
  'map.driveModeOn': 'Fahrmodus einschalten',
  'map.driveModeOff': 'Fahrmodus ausschalten',
  'map.driveModeNoHeading': 'Noch kein Kurs verfügbar – die Karte dreht sich, sobald das GPS eine Fahrtrichtung meldet.',
  ...
  // --- Karte offline ----------------------------------------------------
  'map.offlineDownload': 'Offline-Karten herunterladen',
  'map.offlineClose': 'Downloadmodus beenden',
  'map.offlineTitle': 'Offline-Karten',
  'map.offlineIntro': 'Felder entlang der Route antippen und herunterladen.',
  'map.offlineZoomRange': 'Zoom {min}–{max}.',
  'map.offlineNoRoute': 'Noch keine Route vorhanden – erst eine Route abstecken oder losfahren.',
  'map.offlineUnsupported': 'Dieser Browser kann keine Karten offline speichern.',
  'map.offlineTapToSelect': 'Zum Auswählen antippen',
  'map.offlineLegendSelected': 'ausgewählt',
  'map.offlineLegendDownloaded': 'offline verfügbar',
  'map.offlineSelected_one': '{count} Feld gewählt',
  'map.offlineSelected_other': '{count} Felder gewählt',
  'map.offlineEstimate': '≈ {tiles} Kacheln · {size}',
  'map.offlineSelectAll': 'Ganze Route',
  'map.offlineClearSelection': 'Auswahl leeren',
  'map.offlineStart': 'Herunterladen',
  'map.offlineCancel': 'Download abbrechen',
  'map.offlineProgress': '{done} von {total} Kacheln',
  'map.offlineNeedsNetwork': 'Zum Herunterladen wird eine Internetverbindung gebraucht.',
  'map.offlineDone': 'Offline-Karten gespeichert',
  'map.offlineAborted': 'Download abgebrochen',
  'map.offlineFailed_one': '{count} Kachel konnte nicht geladen werden',
  'map.offlineFailed_other': '{count} Kacheln konnten nicht geladen werden',
  'map.offlineStored_one': '{count} Bereich offline verfügbar',
  'map.offlineStored_other': '{count} Bereiche offline verfügbar',
  'map.offlineNone': 'Noch keine Bereiche offline gespeichert',
  'map.offlineDelete': 'Löschen',
  'map.offlineSource': 'Raster aus: {source}',
  'map.offlineSourcePlanned': 'geplanter Route',
  'map.offlineSourceTrack': 'aufgezeichnetem Track',
  'map.planOpen': 'Route abstecken',
  'map.planClose': 'Routenplanung beenden',
  'map.planTitle': 'Route abstecken',
  'map.planIntro': 'Auf die Karte tippen setzt einen Wegpunkt. Punkte lassen sich ziehen, ein Tipp darauf entfernt sie wieder.',
  'map.planPoints_one': '{count} Wegpunkt',
  'map.planPoints_other': '{count} Wegpunkte',
  'map.planRemovePoint': 'Wegpunkt entfernen',
  'map.planUndo': 'Letzter zurück',
  'map.planClear': 'Route löschen',
  'map.planDownload': 'Karten für diese Route laden',
