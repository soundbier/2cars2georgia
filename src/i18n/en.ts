...
export const en: Translations = {
  ...
  'map.offlineNoRoute': 'No route yet – plan one on the map or start moving.',
  ...
  'map.offlineSourcePlanned': 'planned route',
  'map.offlineSourceTrack': 'recorded track',
  'map.planOpen': 'Plan a route',
  'map.planClose': 'Close route planning',
  'map.planTitle': 'Plan a route',
  'map.planIntro': 'Tap the map to place a waypoint. Drag points to move them, tap one to remove it.',
  'map.planPoints_one': '{count} waypoint',
  'map.planPoints_other': '{count} waypoints',
  'map.planRemovePoint': 'Remove waypoint',
  'map.planUndo': 'Undo last',
  'map.planClear': 'Clear route',
  'map.planDownload': 'Download maps for this route',
